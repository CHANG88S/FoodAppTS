...
export default function TweetDetailScreen() {
    ...
    // Safely locate the exact tweet matching the tweet ID
    const tweet = userTweets.find((t: any) => t._id === tweetId);
                                ...
                                return (
                                    <View key={comment._id} style={styles.commentItem}>
                                        <View style={styles.commentAvatar}>
                                            <Text style={styles.commentAvatarInitial}>U</Text>
                                        </View>
                                        <View style={styles.commentBody}>
                                            <View style={styles.commentHeaderRow}>
                                                <Text style={styles.commentUserHandle}>{userHandle}</Text>
                                                {isMyComment && (
