                        ...
                        <View style={styles.prefDisplayRow}>
                            <View style={styles.prefDisplayItem}>
                                ...
                                <View style={styles.prefDisplayContent}>
                                    <Text style={styles.prefDisplayValue}>{Math.round((currentUser?.preferences?.sweetness ?? 0.5) * 100)}% Sweetness</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.prefDisplayItem}>
                                ...
                                <View style={styles.prefDisplayContent}>
                                    <Text style={styles.prefDisplayValue}>{Math.round((currentUser?.preferences?.iceLevel ?? 0.5) * 100)}% Ice</Text>
                                </View>
                            </View>
